...
def tree_instances_generation(config_path):
    ...
    def CreateBasicBaseMeshINIFile():
        ...
        create_or_update_ini_file(basemeshes_ini_path, section_options, 'USE_APPLY_SIZE_LIMIT_FOR_VOXELIZE_NODE', False)
    ...
    if (run_generate_road_input or run_make_tree_instances) and run_make_basemeshes:
        ...
        if use_basemesh_ini:
                ...
                if need_update_basemeshes_generated_input_version_property:
                    ...
                    if result.success:
                        ...
                        if result.success:
                            ...
                            lambda_host.set_property('basemeshes_generated_input_entity_id', basemeshes_generated_input_entity_id)
            ...
            if return_code_basemash1 == 0:
                ...
                if need_update_basemeshes_generated_input_version_property:
                    if lambda_host.get_property('basemeshes_generated_input_entity_id'):
    ...
    if run_generate_road_input:
        ...
        lambda_host.log(f'road_regions_namedb_file_path is : {road_regions_namedb_file_path}')
        ...
        lambda_host.log(f'original_road_cave_obj_file_path is : {original_road_cave_obj_file_path}')
        lambda_host.log(f'original_road_level1_heightmap_file_path is : {original_road_level1_heightmap_file_path}')
        lambda_host.log(f'original_road_bedrock_heightmap_file_path is : {original_road_bedrock_heightmap_file_path}')
        lambda_host.log(f'original_road_exposure_mask_file_path is : {original_road_exposure_mask_file_path}')
        lambda_host.log(f'original_road_exposure_file_path is : {original_road_exposure_file_path}')    
        ...
        if need_update_tree_program_generated_input_version_property:
            ...
            if result.success:
                ...
                if result.success:
                    ...
                    lambda_host.set_property('tree_program_generated_input_entity_id', tree_program_generated_input_entity_id)
        ...
        #attach_file_to_lambda(api, workflow_project_id, lambda_entity_id, road_regions_namedb_file_path)
...
Grid_Delta = lambda_host.input_string('grid_delta', 'grid_delta', '')
lambda_host.log(f'Grid_Delta: {Grid_Delta}')
Initial_Density = lambda_host.input_string('initial_density', 'initial_density', '')
lambda_host.log(f'Initial_Density: {Initial_Density}')
Seed_Density = lambda_host.input_string('seed_density', 'seed_density', '')
lambda_host.log(f'Seed_Density: {Seed_Density}')
Competition_Factor = lambda_host.input_string('competition_factor', 'competition_factor', '')
lambda_host.log(f'Competition_Factor: {Competition_Factor}')
Growth_Factor = lambda_host.input_string('growth_factor', 'growth_factor', '')
lambda_host.log(f'Growth_Factor: {Growth_Factor}')
Thinning_Threshold = lambda_host.input_string('thinning_threshold', 'thinning_threshold', '')
lambda_host.log(f'Thinning_Threshold: {Thinning_Threshold}')
...
caves_dungeons_asset_active_version_property = lambda_host.input_string('caves_dungeons_asset_active_version_property', 'caves_dungeons_asset_active_version_property', '')
...
lambda_host.log('caves_dungeons_asset_active_version_property: ' + caves_dungeons_asset_active_version_property)
...
caves_dungeons_asset_data_path = lambda_host.download_entity_files(caves_dungeons_asset_active_version_property)
...
lambda_host.log('caves_dungeons_asset_data_path: ' + caves_dungeons_asset_data_path)
...
lambda_host.log(f'start to copy from {caves_dungeons_asset_data_path} to {Data_folder}')
copy_files_in_folder(caves_dungeons_asset_data_path, Data_folder)
lambda_host.log(f'end to copy from {caves_dungeons_asset_data_path} to {Data_folder}')
...
if os.path.exists(tree_program_generated_input_folder):
    ...
    lambda_host.log(f'end to copy from {tree_program_generated_input_folder} to {Data_folder}')
...
#    lambda_host.log(f'end to copy from {tree_program_generated_input_folder} to {tree_output_folder}')
