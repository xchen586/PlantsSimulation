...
bucket_name = lambda_host.get_property("vf_bucket_name")
lambda_host.log(f'bucket_name: {bucket_name}')
access_key_id : str = lambda_host.get_property("vf_access_key")
secret_access_key = lambda_host.get_property("vf_secret_access")
region = lambda_host.get_property("vf_region")
