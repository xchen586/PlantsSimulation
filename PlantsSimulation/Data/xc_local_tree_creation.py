...
def tree_instances_generation(config_path):
    ...
    def CreateBasicBaseMeshINIFile():
        ...
        # Start logging
        print(f'Start to write basic standard basemeshes ini files : {basemeshes_ini_path}')
        ...
        print(f'End to write basic standard basemeshes ini files : {basemeshes_ini_path}')
